...
/**
 * User Data Access Object (DAO). This interface contains all database handling that
...
public interface UserDao {
    ...
    /**
     * searchMatching-method. Used to get the matching user object for the given
     * id.
     *
     * @param uid
     * @return User Object
     ...
     * @throws SQLException
     */
    public abstract void deassign(User user)
            throws NotFoundException, SQLException;
